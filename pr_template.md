# [Andy Duong]'s Submission

**Date**: [12.1.24]

**BU Email**: [aduong06@bu.edu]
...
I liked the design aspect of it and creating a nice aesthetic for the website. I really enjoyed refining the website and connecting the frontend/backend together, making the website interactive. However, I definitely had trouble with time-management as I didn't fully flesh out the project.
...
Yes, it was the assessment that I expected. If I had another two weeks to work on it, I'd finish the lesson sections and create a different aesthetic for each lesson. For example, for the 90's era website lesson, I would create a design for the lesson site that mimics the aesthetic (like using a classic cursor).
